...
import { Building, Users, Syringe, Bug, BadgeDollarSign, AlertTriangle } from 'lucide-react';
...
const OpdFaskes = () => {
  ...
  const faskesPendanaan = 18; // Dummy data
  const faskesDaerahRawan = 8; // Dummy data
  ...
  return (
    <DashboardLayout title="Data Fasilitas Kesehatan" activeLink="faskes">
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-6">
          ...
          />
          <CardStat 
            title="Faskes Menerima Pendanaan" 
            value={`${faskesPendanaan} Faskes`}
            icon={<BadgeDollarSign />} 
            trend="up" 
            trendValue="3 dari tahun lalu" 
          />
          <CardStat 
            title="Faskes di Daerah Rawan" 
            value={`${faskesDaerahRawan} Faskes`}
            icon={<AlertTriangle />} 
            trend="stable" 
            trendValue="0 perubahan" 
          />
        </div>
